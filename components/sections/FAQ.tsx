...
const FAQS = [
  { q: "How is your pricing structured?", a: "Project work is fixed-fee, quoted after the discovery call. Ongoing performance and automation retainers are monthly, scoped to the channels and hours involved. You always know the number before any work starts, with no percentage-of-spend surprises." },
  ...
  { q: "Do you build websites, or only run marketing on them?", a: "Both. I build on Shopify, WordPress, Wix Studio, Webflow, and custom stacks. Because I also run campaigns, everything is built to convert and to measure." },
