...
export const COUNTRIES: Country[] = [
  ...
  { iso: "AG", dial: "1", name: "Antigua & Barbuda" },
  ...
  { iso: "BA", dial: "387", name: "Bosnia & Herzegovina" },
  ...
  { iso: "CD", dial: "243", name: "Congo - Kinshasa" },
  ...
  { iso: "HK", dial: "852", name: "Hong Kong SAR China" },
  ...
  { iso: "MO", dial: "853", name: "Macao SAR China" },
  ...
  { iso: "PS", dial: "970", name: "Palestinian Territories" },
  ...
  { iso: "ST", dial: "239", name: "São Tomé & Príncipe" },
  ...
  { iso: "BL", dial: "590", name: "St. Barthélemy" },
  { iso: "SH", dial: "290", name: "St. Helena" },
  { iso: "KN", dial: "1", name: "St. Kitts & Nevis" },
  { iso: "LC", dial: "1", name: "St. Lucia" },
  { iso: "MF", dial: "590", name: "St. Martin" },
  { iso: "PM", dial: "508", name: "St. Pierre & Miquelon" },
  { iso: "VC", dial: "1", name: "St. Vincent & Grenadines" },
  { iso: "SD", dial: "249", name: "Sudan" },
  { iso: "SR", dial: "597", name: "Suriname" },
  { iso: "SJ", dial: "47", name: "Svalbard & Jan Mayen" },
  ...
  { iso: "TT", dial: "1", name: "Trinidad & Tobago" },
  ...
  { iso: "TC", dial: "1", name: "Turks & Caicos Islands" },
  ...
  { iso: "WF", dial: "681", name: "Wallis & Futuna" },
